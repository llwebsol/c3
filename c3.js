(function (window) {
    ...
    c3.generate = function (config) {
        ...
        function getLegendWidth() {
            return __legend_show ? isLegendRight || isLegendInset ? legendItemWidth * (legendStep + 1.2) : currentWidth : 0;
        }
...
*/
        ...
        function updateLegend(targetIds, options, transitions) {
            ...
            var withTransition, withTransitionForTransform, getLegendText;
